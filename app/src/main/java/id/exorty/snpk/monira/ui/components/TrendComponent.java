...
import id.exorty.snpk.monira.ui.model.CustomDataEntry;
import id.exorty.snpk.monira.ui.model.DataInfo;

public class TrendComponent extends LinearLayout {
    private static TextView txtCardHeader;

    private static Context mContext;
    private static LinearLayout mBackgroundProcessLayout;
    private static AVLoadingIndicatorView mAvloadingIndicatorView;
    private static AnyChartView mAnyChartView;
    private static Cartesian mCartesian;
    private static Line mRealization;
    private static Line mPrognosis;
    private static Line mLastYear;
    ...
    public static void createData(JsonObject jsonObject){
    ...
    public static void startUpdateDate(){
