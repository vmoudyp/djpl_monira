...
public class PieView extends View {
    ...
    private static final int DEFAULT_PERCENTAGE_SIZE = 20;
    private static final int DEFAULT_INNER_CIRCLE_PADDING = 25;
    ...
    private void setupWidgetWithParams(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            String fontName = a.getString(R.styleable.PieView_font_name);

            mPercentageTextView.setTypeface(Util.setTypeface(context, fontName), Typeface.BOLD);
